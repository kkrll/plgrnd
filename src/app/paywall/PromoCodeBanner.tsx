      ...
      <div className="bg-gradient-to-r from-[#1e3a8a] via-[#5b21b6] to-[#6b21a8] rounded-2xl py-4 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2 w-full">
            ...
            <div className="h-[2px] w-full border-t-2 border-dashed border-white/30" />
            <svg viewBox="0 0 12 24" className="w-3 h-6">
          ...
          <div className="flex items-center justify-between gap-2 px-4">
            <div className="bg-[#1e1b4b] border-2 border-[#4c1d95]  w-full rounded-2xl px-6 py-3 flex items-center gap-3">
              <svg
              ...
              <span className="text-white font-medium">name_oct25</span>
            </div>

            <div className="flex justify-center rounded-xl px-2 py-1 h-full bg-[#F4EAFE3D] w-[96px]">
              <div className="flex items-baseline gap-1">
                <div className="text-center">
                  <div className=" font-bold text-white">{mins}</div>
                  <div className="text-[10px] text-white/60 uppercase">min</div>
                </div>
                <div className="font-bold text-white">:</div>
                <div className="text-center">
                  <div className="font-bold text-white">{secs}</div>
                  <div className="text-[10px] text-white/60 uppercase">sec</div>
                </div>
              </div>
            </div>
          </div>
