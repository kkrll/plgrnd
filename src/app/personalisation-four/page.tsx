  ...
  return (
    <div className="bg-[#f3f4f7] relative w-full min-h-screen">
      ...
      <div className="absolute content-stretch flex flex-col gap-[24px] items-end left-[23px] top-[128px] w-[calc(100%-46px)] max-w-[512px]">
        ...
        {/* Progress Card */}
        <div className="backdrop-blur-[20px] w-full backdrop-filter bg-white box-border content-stretch flex flex-col gap-[16px] items-start px-[24px] pt-[24px] pb-[16px] relative rounded-[32px] shadow-[0px_8px_40px_0px_rgba(0,0,0,0.12)] shrink-0 max-w-full">
          {/* Header */}
